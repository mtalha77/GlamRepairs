...
function Tag({ label, icon, tone, className = "" }: TagProps) {
  ...
  return (
    ...
    >
      ...
      <span className="whitespace-nowrap font-sans text-[17px] font-normal uppercase leading-none tracking-[-0.01em] text-brand-ink sm:text-[20px] lg:text-[22px]">
        {label}
      </span>
    </div>
  );
...
function Quote({ className = "" }: { className?: string }) {
  return (
    <div className={`relative ${className}`}>
      ...
      <p className="relative px-8 py-6 text-center font-sans text-[17px] italic leading-tight tracking-[-0.03em] text-brand-ink sm:text-[22px] lg:whitespace-nowrap lg:px-6 lg:py-7 lg:text-[28px]">
