 ...
 * schema id param ships — see app/about/page.tsx) the FAQPage structured
 * data. Never let the two diverge: marked-up FAQ content that isn't visible
 * on the page is a structured data violation.
 *
 * Two corrections from the previous copy: "Are my photographs private?" no
 * longer overstates (no "anonymous case ID" claim, and it now discloses the
 * third-party-channel caveat the Privacy Policy carries); "Is this a medical
 * consultation?" is new.
 */
export const ABOUT_FAQS: AboutFaqItem[] = [
  {
    ...
    answer:
      "No. Every assessment is reviewed and written manually by a " +
      "certified aesthetics professional. There are no algorithms, " +
      "automated reports or AI-generated routines.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Skin Clarity is delivered within 24 hours of confirmed payment " +
      "and usable photographs. Skin Transform is delivered within 24 " +
      "hours with priority review.",
  },
  {
    question: "Do you recommend specific brands?",
    answer:
      "No. We guide you on ingredient types and product categories so " +
      "you can choose whatever is available and affordable, with no " +
      "brand bias and no commission.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Your photographs are used only to prepare your assessment. They " +
      "are seen by the practitioner assigned to your case, never " +
      "published or used in marketing without your separate written " +
      "permission, and never sold. We delete our copies within 30 days, " +
      "and you can request deletion at any time. If you send " +
      "photographs through a third-party messaging service, a copy also " +
      "remains in your own account there, which only you can delete — " +
      "our Privacy Policy explains this in full.",
  },
  {
    question: "Is this a medical consultation?",
    answer:
      "No. Glam Repairs provides cosmetic skincare guidance, not medical " +
      "care. We do not diagnose conditions or prescribe medication. If " +
      "your skin concern is painful, spreading, bleeding or changing " +
      "rapidly, please see a doctor or dermatologist — and if we believe " +
      "that is the case, we will tell you and refund you.",
  },
];
